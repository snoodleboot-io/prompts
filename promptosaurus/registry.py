...
class Registry(BaseModel):
    ...
    mode_files: dict[str, list[str]] = {
        ...
        "document": [
            "document-strategy-for-applications.md",
        ],
        "explain": [
            "explain-strategy.md",
        ],
    ...
    concat_order: list[tuple[str, str]] = [
        ...
        ("DOCUMENTATION", "document-strategy-for-applications.md"),
        ...
        ("DECISION LOG TEMPLATE", "core-decision-log-template.md"),
