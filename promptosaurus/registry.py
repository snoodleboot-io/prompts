...
class Registry(BaseModel):
    ...
    mode_files: dict[str, list[str]] = {
        ...
        "debug": [
            ...
            "core-session-troubleshooting.md",
        ],
        "ask": [
            "ask-docs.md",
            "ask-testing.md",
    ...
    concat_order: list[tuple[str, str]] = [
        ...
        ("SESSION TROUBLESHOOTING", "core-session-troubleshooting.md"),
